...
public class Lugares implements ActionListener{
	...
	public Lugares() {
		...
		jlb1 = new JLabel();
		jlb1.setText("IP: ");
		jlb1.setBounds(145, 50, 80, 30);
		jpnPrincipal2.add(jlb1);
		
		//LABEL 2
		
		jlb2 = new JLabel();
		jlb2.setText("Maquina : ");
		jlb2.setBounds(110, 90, 190, 30);
		jpnPrincipal2.add(jlb2);
		
		//LABEL TITULO
		
		jlb3 = new JLabel("FORMULARIO LUGARES");
		...
		//IMAGEN
		JLabel jlbImagen1= new JLabel(new ImageIcon(Lugares.class.getResource("/imagenes/caliz.jpg")));
